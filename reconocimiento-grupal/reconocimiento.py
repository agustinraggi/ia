...
imagaFacesPath = "C:/Users/Agustin/Desktop/python/reconocimiento-facial/reconocimiento-grupal/faces"

facesEncodings = []

facesNames = []

for file_name in os.listdir(imagaFacesPath):

    image = cv2.imread(imagaFacesPath + "/" + file_name)
